...
# Returns a function that casts both spells simultaneously as a tuple
...
# Returns a new spell function that multiplies the original power.
def power_amplifier(base_spell: Callable, multiplier: int) -> Callable:
    print(f"\n\033[1;34mTesting power amplifer "
          f"{base_spell.__name__}...\033[0m")
...
# Returns a new spell function that only executes if the condition is True.
...
# Returns a function that casts a list of spells in order and returns a
# list of results.
